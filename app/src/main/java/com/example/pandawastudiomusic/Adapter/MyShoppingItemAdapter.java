    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.setiRecyclerItemSelectedListener(new IRecyclerItemSelectedListener() {
            ...
            public void onItemSelectedListener(View view, int pos) {
                ...
                cartItem.setProductQuantity(1L);
                cartItem.setProductPrice(shoppingItemList.get(pos).getPrice());
                cartItem.setUserMail(Common.currentUser.getEmail());


                //insert ke db
                DatabaseUtils.insertToCart(cartDatabase,cartItem);
                Toast.makeText(context, "Tambah ke Keranjang!", Toast.LENGTH_SHORT).show();
            }
        });
    }
