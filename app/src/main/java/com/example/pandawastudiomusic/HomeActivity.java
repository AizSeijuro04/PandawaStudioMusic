...
import com.example.pandawastudiomusic.Fragments.HomeFragment;
import com.example.pandawastudiomusic.Fragments.ShopingFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (signInAccount != null){
            DocumentReference currentUser = userRef.document(Objects.requireNonNull(signInAccount.getEmail()));
            currentUser.get()
                    .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            if (task.isSuccessful())
                            {
                                ...
                                {
                                    showUpdateDialog(signInAccount.getEmail());
                                }
                                else
                                {
        ...
        //if login false, just let user around shoping to view
